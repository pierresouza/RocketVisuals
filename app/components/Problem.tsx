  ...
  return (
    <section id="problema" className="bg-linear-to-b from-black to-gray-900 py-20">
      <div className="w-full max-w-6xl mx-auto px-6" data-aos="fade-up">
        <h2 className="text-5xl md:text-6xl font-black mb-4 uppercase">O problema não é a falta de vídeo</h2>
        <p className="text-xl text-gray-400 mb-12">É a falta de estratégia.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4 uppercase">Vídeos Improvisados</h3>
            <p className="text-gray-400">Sem planejamento, sem estratégia, sem objetivo claro. Resultado: conteúdo que não gera retorno.</p>
          </div>
          <div
          ...
          >
            <div className="text-4xl mb-4">🎭</div>
            <h3 className="text-2xl font-bold mb-4 uppercase">Sem Direção Criativa</h3>
            <p className="text-gray-400">Falta de narrativa e posicionamento. O público não se conecta.</p>
          </div>
          <div
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4 uppercase">Produto Parece Comum</h3>
            <p className="text-gray-400">Sem impacto na apresentação e sem diferenciação. Seu produto vira mais um.</p>
          </div>
          <div
          ...
          >
            <div className="text-4xl mb-4">📉</div>
            <h3 className="text-2xl font-bold mb-4 uppercase">Marca Perde Atenção</h3>
            <p className="text-gray-400">Baixa retenção, pouco engajamento e zero impacto.</p>
          </div>
        </div>
        <div className="bg-linear-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/50 rounded-xl p-8 text-center mb-16">
          <p className="text-3xl md:text-4xl font-black text-white uppercase">EU TRANSFORMO ATENÇÃO EM DESEJO. 🔥</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-6 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="text-gray-400">dos vídeos são ignorados porque não prendem atenção</p>
          </div>
          <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-6 text-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <p className="text-gray-400">das marcas perdem vendas por falta de estratégia de posicionamento</p>
          </div>
          <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-6 text-center" data-aos="fade-up" data-aos-delay="300">
            ...
            <p className="text-gray-400">mais conversão com conteúdo estratégico</p>
          </div>
        </div>
      </div>
    </section>
