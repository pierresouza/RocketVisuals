  ...
  const services = [
    {
      ...
      description: "Produção com técnicas e linguagem cinemáticas, uso de roteiro, captação, direção criativa e pós-produção de alto padrão, pensado para posicionar sua marca e aumentar a percepção de valor",
    ...
    },
    {
      ...
      description: "Produção inteligente com o uso de IA. Mais rápido, escalável e alinhado com sua estratégia usando as mesmas técnicas dos conteúdos cinemáticos",
    ...
    },
    {
      icon: "✨",
      title: "VFX PREMIUM",
      description: "Produção com softwares 3D e técnicas de realidade aumentada ideal para campanhas. Conteúdos impossíveis de ignorar.",
