        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold mb-3 text-white uppercase">Estética Cinemática</h3>
              <p className="text-gray-300">Qualidade que prende a atenção e posiciona sua marca como premium.</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-5xl mb-4">✨</div>
              <h3 className="text-2xl font-bold mb-3 text-white uppercase">Efeitos Visuais</h3>
              <p className="text-gray-300">Diferenciação real que faz seu conteúdo se destacar.</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-5xl mb-4">📖</div>
              <h3 className="text-2xl font-bold mb-3 text-white uppercase">Narrativa Forte</h3>
              <p className="text-gray-300">Storytelling pensado para gerar desejo.</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-5xl mb-4">🚀</div>
              <h3 className="text-2xl font-bold mb-3 text-white uppercase">Impacto Imediato</h3>
              <p className="text-gray-300">Conteúdo pensado para converter, não só impressionar.</p>
            </div>
          </div>
        </div>
      </div>
